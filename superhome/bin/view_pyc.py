...
'''
view_pyc allows to view the disassembly of a pyc file
taken from here: https://stackoverflow.com/questions/11141387/given-a-python-pyc-file-is-there-a-tool-that-let-me-view-the-bytecode

usage: python view_pyc [some_file].pyc
'''
