...
local menu = '$SUPERHOME/bin/fuzzelpicker'
local statusBar = 'ashell'

-- https://www.reddit.com/r/hyprland/comments/1h4abmt/how_do_i_apply_dark_theme/

-- GTK4 apps
local gtk4_theme = "gsettings set org.gnome.desktop.interface color-scheme 'prefer-dark'"

-- GTK3 apps
local gtk3_theme = "gsettings set org.gnome.desktop.interface gtk-theme 'adw-gtk3'"

-- QT from KDE
local env_qt_theme_var = 'QT_QPA_PLATFORMTHEME'
...
-- Nodar EXTRAS UNTIL THIS IS MOVED AND ORGANIZED
